...
public enum SingleSkillPresentTense {
	...
	SENTENCE_1("Assisting the execution of %s activity for more than %d months to support excellent results."),
	SENTENCE_2("Accountable for %s support activity in a junior role for %d months, delivering strong outcomes.");
