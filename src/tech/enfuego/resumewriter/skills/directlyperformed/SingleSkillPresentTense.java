...
public enum SingleSkillPresentTense {
	...
	SENTENCE_1("Directly contributing to %s activity for more than %d months with excellent results."),
	SENTENCE_2("Accountable for %s activity in an individual contributor capacity for %d months, delivering strong outcomes.");
